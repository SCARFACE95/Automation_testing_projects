...
class TestUpdateOrder:
    ...
    def test_update_order_with_valid_order_id(self):
        ...
        #Verific cu get dupa ce s-a facut comanda si sa vad daca apare customerName
        get_order_after_submit = get_order(submit_order_id).json()
        print(get_order_after_submit)
        ...
        print(get_order_response.json()) #Am printat JSON ca sa ma verific
